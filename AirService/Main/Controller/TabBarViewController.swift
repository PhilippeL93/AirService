...
class TabBarViewController: UITabBarController {
    ...
    func setTabBarItems() {
        ...
        myTabBarItem1.imageInsets = UIEdgeInsets(top: 3, left: 0, bottom: 0, right: 0)

        let myTabBarItem2 = (self.tabBar.items?[1])! as UITabBarItem
        myTabBarItem2.image = UIImage(awesomeType: .star, size: 15)
        myTabBarItem2.title = "Mes Villes"
        myTabBarItem2.imageInsets = UIEdgeInsets(top: 3, left: 0, bottom: 0, right: 0)

        let myTabBarItem3 = (self.tabBar.items?[2])! as UITabBarItem
        myTabBarItem3.image = UIImage(awesomeType: .cog, size: 15)
        myTabBarItem3.title = "Paramètres"
        myTabBarItem3.imageInsets = UIEdgeInsets(top: 3, left: 0, bottom: 0, right: 0)
    }
}
